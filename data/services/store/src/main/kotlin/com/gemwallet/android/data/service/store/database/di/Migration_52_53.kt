...
object Migration_52_53 : Migration( 52, 53) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("ALTER TABLE balances ADD COLUMN energy_available INTEGER NOT NULL DEFAULT 0")
        db.execSQL("ALTER TABLE balances ADD COLUMN energy_total INTEGER NOT NULL DEFAULT 0")
        db.execSQL("ALTER TABLE balances ADD COLUMN bandwidth_available INTEGER NOT NULL DEFAULT 0")
        db.execSQL("ALTER TABLE balances ADD COLUMN bandwidth_total INTEGER NOT NULL DEFAULT 0")
