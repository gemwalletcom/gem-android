...
ios_localization_dir="ios/Assets"
# Android
android_data='{
  "format": "xml",
  "export_empty_as": "base",
...
android_localization_dir="ui/src/main/res"
...
case $1 in
  "ios")
    download_bundle "ios" "$ios_data" "$ios_localization_dir"
  ;;
  "android")
    download_bundle "android" "$android_data" "$android_localization_dir"
  ;;
esac