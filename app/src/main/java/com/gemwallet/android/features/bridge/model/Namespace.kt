package com.gemwallet.android.features.bridge.model

import com.wallet.core.primitives.Chain
import com.wallet.core.primitives.WalletConnectionMethods

internal enum class ChainNamespace(val string: String, val methods: List<WalletConnectionMethods>) {
    Eip155(
        "eip155",
        listOf(
...
internal fun Chain.getNameSpace(): ChainNamespace? {
    return when (this) {
        Chain.Ethereum,
        Chain.SmartChain,
        Chain.Base,
...
internal fun Chain.getReference(): String? {
    return when (this) {
        Chain.Ethereum -> "1"
        Chain.SmartChain -> "56"
        Chain.Base -> "8453"
...
internal fun Chain.Companion.findByNamespace(namespace: String, reference: String): Chain? {
